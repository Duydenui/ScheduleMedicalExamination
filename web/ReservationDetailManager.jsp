                    ...
                    <div class="container">
                        <div class="box">
                            <div class="section-title">
                                <h1 class="heading">The reciever information</h1>
                            </div>
                            <div class="box-body overflow-scroll">


                                <div class="customer-in4">
                                    <div class="user_in4"><h2>Name: ${informationUserReservation.user_name}</h2></div>
                                <div class="user_in4"><h2>Gender: <c:if test="${informationUserReservation.user_gender == true}">
                                            Male
                                        </c:if>
                                ...
                                <div class="user_in4"><h2>Email: ${informationUserReservation.user_email}</h2></div>
                                <div class="user_in4"><h2>Phone: ${informationUserReservation.user_phone}</h2></div>
                            </div>
                            ...
                            <table>
                                ...
                                <tbody>
                                        <tr>
                                            <td>${childrenInfo.childrenName}</td>
                                            <td>
                                                <c:if test="${childrenInfo.childrenGender == true}">
                                                    Male
                                                </c:if>
                                                <c:if test="${childrenInfo.childrenGender == false}">
                                                    Female
                                                </c:if>
                                            </td>
                                            <td>${childrenInfo.childrenAge}</td>
                                        </tr>
                                </tbody>
