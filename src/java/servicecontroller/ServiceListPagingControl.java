 ...
 * @author _DELL_
 */
public class ServiceListPagingControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int serviceIndexPage = Integer.parseInt(index);
        ServicesDAO dao = new ServicesDAO();
        BlogsDAO blog = new BlogsDAO();
        List<servicelist> list = dao.getPaging(serviceIndexPage);
