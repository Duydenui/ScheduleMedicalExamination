...
public class reservationlist {
    ...
    public reservationlist(int reservation_id, Date created_date, String user_fullname, String service_title, int num_of_person, String children_name, float total_price, int reservation_status) {
