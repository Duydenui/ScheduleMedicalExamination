                            ...
                            <tbody>
                                <c:forEach items="${listser}" var="LS">
                                    <tr>
                                        ...
                                        <td><a href="/Child-care-system/servicedetail?svid=${LS.slider_id}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" color="#8e44ad" class="bi bi-back" viewBox="0 0 16 16">
                                                <path d="M0 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-2H2a2 2 0 0 1-2-2V2zm2-1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H2z"/>
                                                </svg>
                                            </a></td>
                                        <td><a href="editsliderdetailmanager?slider_id=${LS.slider_id}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" color="#8e44ad" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                        ...
                                        <td>
                                            <a href="showslidedetailmanager?slider_id=${LS.slider_id}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" color="#8e44ad" class="bi bi-eye" viewBox="0 0 16 16">
...
<script>
                                                        function changeStatus(btn, id, status) {
                                                            $.ajax({
                                                                url: '/Child-care-system/listslidermanager',
                                                                type: 'POST',
                                                                data: {
                                                                    id: id,
                                                                    status: status
