 ...
 * @author Dell
 */
//@WebServlet("/reservation-contact")
public class ReservationContactController extends HttpServlet {

    private final DoctorWorkingSlotDAO doctorWokingSlotDAO = new DoctorWorkingSlotDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dateString != null) {
            ...
            List<DoctorWorkingSlot> dws = doctorWokingSlotDAO.getAllsByDate(date);
            UserDAO userDAO = new UserDAO();
            List<user> doctorList = new ArrayList<>();
            Set<Integer> doctorIds = new HashSet<>();
            for (DoctorWorkingSlot d : dws) {
            ...
            if (doctor != null) {
                request.setAttribute("doctorId", doctor);
                ...
                for (DoctorWorkingSlot d : dws) {
                    if (d.getDoctorId() == did) {
                        switch (d.getSlot()) {
                            case 1:
                                slots.put(1, "7h30 - 9h20");
                                break;
                            case 2:
                                slots.put(2, "9h30 - 12h");
                                break;
                            case 3:
                                slots.put(3, "12h00 - 15h30");
                                break;
                            case 4:
                                slots.put(4, "15h40 - 17h30");
                                break;
                            default:
                                break;
                        }
...
//                    System.out.println("children id  " + reservationDetail.getChildren_id());
                        doctorWokingSlotDAO.setBusy(reservationDetail.getDoctor_id(), reservationDetail.getSlot());
            ...
            System.err.println("LOi NEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE:" + e.getMessage());
