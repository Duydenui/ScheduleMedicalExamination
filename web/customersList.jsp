...
<body>
    ...
    <jsp:include page="assets/module/sidebar.jsp"></jsp:include>
        ...
        <!-- ======= Breadcrumbs Section ======= -->
        <div class="container">
            <div class="filter-content" style="text-align: left; height: 710px">
                <div>
                    <h5>SEARCH</h5>
                    <nav style="display: block">
                        <form action="filtercustomer" class="form-inline">
        ...
        <div class="user-list">
            <div>
                ...
                <c:if test="${u.user_role == 5}">
                    <a href="addNewUser.jsp"><button type="button" class="btn btn-primary">${u.user_role != 5}ADD NEW</button></a>
                </c:if>
            </div>
                    ...
                    <c:forEach items="${list_user}" var="u">
                        ...
                        <div class="post-box">
                            ...
                            <div class="blog-item">
                                ...
                                <p class="card-text">Name: ${u.user_name}</p>
                                <p class="card-text">Email: ${u.user_email}</p>
                                <p class="card-text">Phone: ${u.user_phone}</p>
                                <c:forEach items="${list_role}" var="r">
                                    <c:if test="${r.role_id == u.user_role}">
                                        <p class="card-text">Role: ${r.role_name}</p>
                                    </c:if>
                                </c:forEach>
                                <c:choose>
...
<script>
                            function searchByName(param) {
                                ...
                                $.ajax({
                                    url: "/Child-care-system/searchCustomer",
