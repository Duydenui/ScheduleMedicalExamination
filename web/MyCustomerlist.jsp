                                        ...
                                        <tbody>
                                            ...
                                            <%
                                                try {
                                                    ...
                                                    String sql = "SELECT reservation_detail.reservation_id, service.service_title, children.children_name , begin_time,slot\n"
                                                            + "FROM reservation_detail\n"
                                                            + "join reservation on reservation.reservation_id=reservation_detail.reservation_id\n"
                                                            + "join service on service.service_id=reservation_detail.service_id\n"
                                                            + "join children on children.children_id=reservation_detail.children_id\n"
                                                            + "WHERE doctor_id = ?\n"
                                                            + "GROUP BY reservation_detail.reservation_id, service.service_title, begin_time, children.children_name , begin_time , slot\n"
