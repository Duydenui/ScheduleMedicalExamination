...
public class Constance {
    ...
    final public static String DATABASENAME = "ChildrenCare";
     ...
     * setup gửi gmail
     */
    final public static String SENDGMAIL_TK = "khanhtdhe163337@fpt.edu.vn";
    final public static String SENDGMAIL_MK = "123";
}
