                                        ...
                                        <c:forEach  items="${requestScope.reservationlist}" var="reservation">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="order-status order-ready">${reservation.children_name}</span>
                                                </td>
                                                ...
                                                <td><button type="button" class="inline-btn"><a style="color: white;" href="/Child-care-system/ReservationDetailController1?res_id=${reservation.reservation_id}">Detail</a></button></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
