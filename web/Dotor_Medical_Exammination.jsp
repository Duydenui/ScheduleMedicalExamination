    ...
    <body>
                                    ...
                                    <div class="box-body overflow-scroll" style=" overflow-y: auto;">
                                        <table id="examples">
                                            ...
                                            try {
                                                ...
                                                ps.setString(1, request.getAttribute("docid").toString());
                                                ResultSet rs = ps.executeQuery();
                                                while (rs.next()) {
                                                    int reservationStatus = rs.getInt(5); // Assuming the status is an integer

                                                    String statusClass = ""; // This will store the CSS class for the status
                                                    String statusText = ""; // This will store the text for the status
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="inline-btn" onclick="viewReservationDetail('<%=rs.getString(1)%>')">Detail</button>
                                                </td>
                                                <% 
                                                    // Add this conditional statement to check if the status is not 4
                                                    if (reservationStatus != 4) {
                                                %>
                                                <td>
                                                    <button onclick="addMedical('<%=rs.getString(1)%>')">
        ...
        <!--        <script>
                                                                    function submit(res_id) {
                                                                        ...
                                                                        if (confirm(text) == true) {
                                                                            window.location = "/Child-care-system/submitreservation?res_id=" + res_id;
                                                                        } else {
                                                                            text = "You canceled!";
                                                                        }
                                                                    }
        ...
        <script>
                    function viewReservationDetail(reservationId) {
                        window.location = "/Child-care-system/ReservationDetailController1?res_id=" + reservationId;
                    }
                    function addMedical(reservationId) {
                        window.location = "/Child-care-system/addexamination?res_id=" + reservationId;
                    }
        </script>
