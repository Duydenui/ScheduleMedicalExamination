                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${requestScope.listSetting}" var="LR">
                        ...
                        <c:if test="${LR.setting_status == true}">
                            <form action="/Child-care-system/Admin/setting-list?id=${LR.setting_id}&status=1" method="POST">
                        ...
                        <c:if test="${LR.setting_status == false}">
                            <form action="/Child-care-system/Admin/setting-list?id=${LR.setting_id}&status=0" method="POST">
                        ...
                        <td><button onclick="window.location.href='/Child-care-system/Admin/settingdetail?setting_id=${LR.setting_id}'" type="button" class="btn btn-primary">Edit</button></td>
                        </tr>
